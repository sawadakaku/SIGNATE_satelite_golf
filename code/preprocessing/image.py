...
class ImageDataGenerator(object):
    ...
    def flow_from_directory(self, directory,
        ...
        # Arguments
                ...
                color_mode: one of "grayscale", "rbg", "landsat". Default: "rgb".
...
class DirectoryIterator(Iterator):
    ...
    # Arguments
        ...
        color_mode: One of `"rgb"`, `"grayscale"`, `"landsat"`. Color mode to read images.
    ...
    def __init__(self, directory, image_data_generator,
        ...
        if color_mode not in {'rgb', 'grayscale', 'landsat'}:
    ...
    def _get_batches_of_transformed_samples(self, index_array):
        ...
        for i, j in enumerate(index_array):
            ...
            import tifffile
            x = tifffile.imread(os.path.join(self.directory, fname))
